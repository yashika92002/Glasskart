    ...
    return list.map((item) => {
      return (<div>
        {item.position == 1 ?
          ...
          <div style={{position:'absolute' ,top:'35%',left:'60%'}}>  <h1 style={{ letterSpacing: 0.5,
            
              color: '#50526e',
              fontWeight: 400, fontFamily: 'ubuntu, sans-serif',textAlign:'center' }}>Stylish Eyewear That<div> Is Premium, Not Expensive!</div></h1>
