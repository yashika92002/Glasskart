    ...
    if (!err) {
      ...
      if (result) {
        Swal.fire({
          ...
          title: 'GlassKart.com',
          text: 'Colors Submitted Successfully'
        })
      }
      else {
        Swal.fire({
            ...
            <div className={classes.subdiv}>
                <div style={{ width: 480 }}>
                    <div style={{ fontSize: 20, fontWeight: "bold", letterSpacing: 1, alignItems: "center", justifyContent: "center", display: "flex" }}>
                        <span><img src="/glasscart.png" width="40" /></span><span style={{ fontSize: 30 }}>Add Color</span>
                    </div>
                </div>
                <br></br>
                <Grid container spacing={1}>
                    <Grid item xs={12}>
                        <TextField variant="outlined" label="Color Name" fullWidth
            ...
            <FormControl variant="outlined" fullWidth>
              ...
              >
                ...
                <option >Deactivate</option>
                    ...
                    <Grid item sm={12}>
                        <Button style={{ background: "#22a6b3" }} fullWidth variant="contained" color="primary" onClick={() => handleSubmit()}>Submit Color</Button>
                    </Grid>
                </Grid>
            </div>
            <ToastContainer
